        ...
        <header id="navigation" class="navbar-inverse navbar-fixed-top animated-header">
            <div class="container">
                ...
                <nav class="collapse navbar-collapse navbar-right" role="navigation">
                  ...
                  <a class="btnbook btn btntn-primary btn-sm" href="https://wa.me/6281222771703"role="button">Book Now</a>
                </nav>
				<!-- /main nav -->
            ...
            <div id="slider" class="sl-slider-wrapper">
				...
				<div class="sl-slider">
					...
					<div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
						...
						<div class="slide-caption">
                            <div class="caption-content">
                                <h2 class="animated fadeInDown">It's</h2>
                                <h2 class="CoCreativewarna">Co Creative</h2>
                                <span class="animated fadeInDown">Your incubator space for start and growing bussines. <br>
                                With co creative, be innovative and bring your bussines throught collaboration</span>
					...
					<div class="sl-slide" data-orientation="vertical" data-slice1-rotation="10" data-slice2-rotation="-15" data-slice1-scale="1.5" data-slice2-scale="1.5">
						...
						<div class="slide-caption">
                            <div class="caption-content">
                                <h2>Create your Own Event with </h2>
                                <h2 class="CoCreativewarna">Co Creative</h2>
							...
							<div class="welcome-block">
								<h3></h3>								
						     	 <div class="message-body">
						       		<p>Our Mission <br>
						       		Be the Leader as Coworking in business development and innovation.Provide all facility on environment in which all tenants can explore creative, productive ideas at work and the opportunity to develop wider business conectivity.</p>
						     	 </div>
						...
						<div id="events" class=" wow animated fadeInUp">
							<div class="events-item text-center">
								<div class="clearfix">
									...
									<p>Need event space to Create great Workshop or Mini Class on your passion ? or do you want to Launch your product and get the best impression on it ?Maybe you want to celebrate something with people ?with Co Creative let’s make any event memorable..</p>
								</div>
								<a href="https://wa.me/6281222771703" class="btn btn-blue btn-effect">Book Now</a>
					...
					<div class="row">
						...
						<ul class="project-wrapper wow animated fadeInUp">
							<li class="portfolio-item">
								<img src="img/gal_garden1.1.jpg" class="img-responsive" alt="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat">
								<figcaption class="mask">
									<h3>Coworking Space</h3>
									<p>High Speed Internet Access,Free Flow Water,Convenience Space & Furniture </p>
								</figcaption>
								<ul class="external">
									<li><a class="fancybox" title="Araund The world" data-fancybox-group="works" href="img/gal_garden2.jpg"><i class="fa fa-search"></i></a></li>
									<li><a href=""><i class="fa fa-link"></i></a></li>
								</ul>
							</li>
							
							<li class="portfolio-item">
								<img src="img/gal_garden2.jpg" class="img-responsive" alt="Lorem Ipsum is simply dummy text of the printing and typesetting ndustry. ">
								<figcaption class="mask">
									<h3>Our Space</h3>
							...
							<li class="portfolio-item">
								<img src="img/event1.jpg" class="img-responsive" alt="Lorem Ipsum is simply dummy text of the printing and typesetting ndustry. ">
								<figcaption class="mask">
									<h3>Event Space</h3>
									<p>Space For 30 - 40 person,Sound System,Flip Chart,Projector / LCD.</p>
								</figcaption>
								<ul class="external">
							...
							<li class="portfolio-item">
								...
								<figcaption class="mask">
									<h3>Meeting Room</h3>
									<p>High Speed Internet Access,LCD / Flip Chart Board,Convenience Space & Furniture. </p>
								</figcaption>
								<ul class="external">
							...
							<li class="portfolio-item">
								<img src="img/gal_garden5.jpg" class="img-responsive" alt="Lorem Ipsum is simply dummy text of the printing and typesetting ndustry. ">
								<figcaption class="mask">
									<h3>Amenities</h3>
									<p>So Refreshing</p>
								</figcaption>
							...
							<li class="portfolio-item">
								<img src="img/officespace_garden.jpg" class="img-responsive" alt="Lorem Ipsum is simply dummy text of the printing and typesetting ndustry. ">
								<figcaption class="mask">
									<h3>Office Space</h3>
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting ndustry. </p>
								</figcaption>
